...
<head>
    ...
    <!-- Title -->
    <title>{{env('PAGENAME')}} | @lang('landing.welcome.title')</title>
...
<nav id="header" class="navbar navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#home">{{env('PAGENAME')}}</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse navbar-right">
            <ul class="nav navbar-nav">
                <li><a href="#home">@lang('landing.navigation.home')</a></li>
                <li><a href="#features">@lang('landing.navigation.features')</a></li>
                <li><a href="#pricing">@lang('landing.navigation.pricing')</a></li>
                <li><a href="#contact">@lang('landing.navigation.contact')</a></li>
            </ul>
        </div>
    </div>
</nav>
    ...
    <div class="container">
        <div class="row">
            <div class="home-text col-md-8">
                <h1 class="wow fadeInDown" data-wow-delay="1.5s" data-wow-duration="1.5s" data-wow-offset="10">@lang('landing.welcome.main', ['name'=>env('PAGENAME')])</h1>
                <p class="lead wow fadeInDown" data-wow-delay="2s" data-wow-duration="1.5s" data-wow-offset="10">@lang('landing.welcome.desc')</p>
                <a href="{{URL::to('auth/register')}}" class="btn btn-default btn-rounded btn-lg wow fadeInUp" data-wow-delay="2.5s" data-wow-duration="1.5s" data-wow-offset="10">@lang('user.register')</a>
                <a href="{{URL::to('auth/login')}}?a=login" class="btn btn-success btn-rounded btn-lg wow fadeInUp" data-wow-delay="2.5s" data-wow-duration="1.5s" data-wow-offset="10">@lang('user.login')</a>
            </div>
            <div class="scroller">
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 wow rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">
                ...
                <h2>@lang('landing.contact.contact')</h2>
                <form class="m-t-md">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-6">
                                <input type="text" class="form-control input-lg contact-name" placeholder="@lang('forms.name')">
                            </div>
                            <div class="col-sm-6">
                                <input type="email" class="form-control input-lg" placeholder="@lang('forms.email')">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control input-lg" placeholder="@lang('forms.subject')">
                    </div>
                    <div class="form-group">
                        <textarea class="form-control" rows="4=6" placeholder="@lang('forms.message')"></textarea>
                    </div>
                    <button type="submit" class="btn btn-default btn-lg">@lang('forms.submit')</button>
                </form>
            </div>
        </div>
    </div>
...
<footer>
    <div class="container">
        <p class="text-center no-s">{{date('Y')}} &copy; {{env('PAGENAME')}}.</p>
    </div>
</footer>
