                        ...
                        <li>
                            ...
                            <a href="#">
                                <ul class="cd-item-wrapper">
                                    <li class="selected" @if($item->discount !=0) data-sale="true"
                                        data-price="{{number_format(round($item->price*(1-$item->discount/100),2),2)}}€" @endif>
                                        <img src="{{$item->image}}" alt="Preview image">
                                    </li>
                                </ul>
                                <div class="cd-item-info">
                                    <b><a href="{{URL::to('shop/product/'.$item->id)}}"
                                          title="{{$item->title}}">{{$item->title}}</a></b>
                                ...
                                <div class="cd-item-details">
                                    <a href="{{URL::to('shop/product/'.$item->id)}}" class="pull-left details"
                                       target="_blank"><i class="fa fa-list-ul"></i>Details</a>
                                </div>
                            </a>
                        </li>
                    @endforeach
